...
class status:
    ...
    def io_stats(self,stats,write=None):
        ...
        # drive_io_old = cache['blkio_stats']['io_service_bytes_recursive']
        try:
            now = drive_io[0]['value'] + drive_io[2]['value']
            # old = drive_io_old[0]['value'] + drive_io_old[2]['value']
        ...
        try:
            ...
            # old = drive_io_old[1]['value'] + drive_io_old[3]['value']
    ...
    def cpu_stats(self,stats,write=None):
        ...
        if cpu > 0 and system > 0:
            self.__stats_tmp['cpu_usage'] = round((cpu / system) * self.__stats_tmp['online_cpus'] * 100,3)
        else:
    ...
    def stats(self,args):
        ...
        write = args.write if hasattr(args,"write") else None
        stats['id'] = args.id
