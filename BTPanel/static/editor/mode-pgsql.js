		...
		function (e, t, n) {
			...
			var r = e('../lib/oop'),
				...
				s = function () {
					...
					this.$rules = {
						start: [
							{ token: 'comment.doc', regex: '^=(?:begin|item)\\b', next: 'block_comment' },
							{
								token: 'string.regexp',
								regex:
									'[/](?:(?:\\[(?:\\\\]|[^\\]])+\\])|(?:\\\\/|[^\\]/]))*[/]\\w*\\s*(?=[).,;]|$)',
			...
			var r = e('../lib/oop'),
				...
				c = function () {
					var e =
						...
						n = this.createKeywordMapper({ 'support.function': t, keyword: e }, 'identifier', !0),
						r = [
							{ token: 'string', regex: "['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']" },
					...
					;(this.$rules = {
						...
						statement: [
							...
							{ token: 'string', regex: '\\$(js|javascript)\\$', next: 'javascript-start' },
