ace.define(
	...
	ace.define(
		'ace/mode/swift_highlight_rules',
		[
			'require',
			'exports',
			'module',
				...
				u = function () {
					function t(e, t) {
						var n = t.nestable || t.interpolation,
							...
							s = { regex: e + (t.multiline ? '' : '(?=.)'), token: 'string.start' },
							o = [
								t.escape && { regex: t.escape, token: 'character.escape' },
								t.interpolation && {
					...
					;(this.$rules = {
						start: [
							...
							n(),
							{ regex: /@[a-zA-Z_$][a-zA-Z_$\d\u0080-\ufffe]*/, token: 'variable.parameter' },
