				...
				1: [
					function (e, t, n) {
						...
						function a(e) {
							return (
								r(e) ||
								(e.namespaceURI === 'http://www.w3.org/1999/xhtml' && e.localName === 'button')
							)
						}
						function f(e) {
							return (
					...
					function (e, t, n) {
						...
						;(f.consumeEntity = function (e, t, n) {
							...
							if (c == '#') {
								c = e.shift(1)
								if (c === i.EOF)
									return t._parseError('expected-numeric-entity-but-got-eof'), e.unget(l), !1
								l += c
								var h = 10,
									p = a
								if (c == 'x' || c == 'X') {
								...
								if (p(c)) {
									...
									return (
										c !== ';' && (t._parseError('numeric-entity-without-semicolon'), e.unget(c)), f
									)
								}
							...
							(r.prototype = {
								...
								peek: function (e) {
									...
									return this.eof && this.start >= this.data.length
										? r.EOF
										: this.data
												.slice(this.start, Math.min(this.start + e, this.data.length))
												.toString()
								},
								length: function () {
						...
						;(i.prototype.isSpecial = function () {
							...
							(i.prototype.isHtmlIntegrationPoint = function () {
								if (this.namespaceURI === 'http://www.w3.org/1998/Math/MathML') {
									...
									return e
										? ((e = e.toLowerCase()), e === 'text/html' || e === 'application/xhtml+xml')
										: !1
								}
					...
					function (e, t, n) {
						...
						;(u.prototype._parseError = function (e, t) {
							...
							(u.prototype.tokenize = function (e) {
								function n(e) {
									var n = e.char()
									if (n === r.EOF) return t._emitToken({ type: 'EOF', data: null }), !1
									if (n === '&') t.setState(a)
									else if (n === '<') t.setState(j)
									else if (n === '\0') t._emitToken({ type: 'Characters', data: n }), e.commit()
									else {
										var i = e.matchUntil('&|<|\0')
										t._emitToken({ type: 'Characters', data: n + i }), e.commit()
									}
									return !0
								}
								function a(e) {
									var r = i.consumeEntity(e, t)
									return t.setState(n), t._emitToken({ type: 'Characters', data: r || '&' }), !0
								}
								function f(e) {
									var n = e.char()
									if (n === r.EOF) return t._emitToken({ type: 'EOF', data: null }), !1
								...
								function l(e) {
									...
									return t.setState(f), t._emitToken({ type: 'Characters', data: n || '&' }), !0
								}
								function c(e) {
									var n = e.char()
									if (n === r.EOF) return t._emitToken({ type: 'EOF', data: null }), !1
								...
								function m(e) {
									var r =
											t._currentToken &&
											t._currentToken.name === this._temporaryBuffer.toLowerCase(),
										i = e.char()
									return (
										s(i) && r
											? ((t._currentToken = {
								...
								function w(e) {
									...
									return (
										n === '/'
											...
											: n === '!'
											  ? (t._emitToken({ type: 'Characters', data: '<!' }), t.setState(x))
											  : (t._emitToken({ type: 'Characters', data: '<' }),
											    e.unget(n),
											    t.setState(p)),
										!0
								...
								function x(e) {
									...
									return (
										n === '-'
											? (t._emitToken({ type: 'Characters', data: '-' }), t.setState(T))
								...
								function T(e) {
									...
									return (
										n === '-'
											? (t._emitToken({ type: 'Characters', data: '-' }), t.setState(k))
											: (e.unget(n), t.setState(p)),
										!0
									)
								}
								function N(e) {
									...
									else if (i === '-') t._emitToken({ type: 'Characters', data: '-' }), t.setState(C)
											  ...
											  : i === '<'
											    ...
											    : i === '\0'
											      ? (t._parseError('invalid-codepoint'),
											        t._emitToken({ type: 'Characters', data: '\ufffd' }),
											        t.setState(N))
											      : (t._emitToken({ type: 'Characters', data: i }), t.setState(N)),
										!0
									)
								}
								function k(e) {
									...
									return (
										i === r.EOF
											? (t._parseError('eof-in-script'), e.unget(i), t.setState(n))
											: i === '<'
											  ? t.setState(L)
											  : i === '>'
											    ? (t._emitToken({ type: 'Characters', data: '>' }), t.setState(p))
											    : i === '\0'
											      ? (t._parseError('invalid-codepoint'),
											        t._emitToken({ type: 'Characters', data: '\ufffd' }),
											        t.setState(N))
								...
								function _(e) {
									...
									return (
										i === r.EOF
											? (t._parseError('eof-in-script'), e.unget(i), t.setState(n))
											: i === '-'
											  ? (t._emitToken({ type: 'Characters', data: '-' }), t.setState(D))
											  : i === '<'
											    ? (t._emitToken({ type: 'Characters', data: '<' }), t.setState(H))
											    : i === '\0'
											      ? (t._parseError('invalid-codepoint'),
											        t._emitToken({ type: 'Characters', data: '\ufffd' }),
											        e.commit())
											      : (t._emitToken({ type: 'Characters', data: i }), e.commit()),
										!0
									)
								}
								function D(e) {
											  ...
											  : i === '<'
											    ...
											    : i === '\0'
											      ? (t._parseError('invalid-codepoint'),
											        t._emitToken({ type: 'Characters', data: '\ufffd' }),
											        t.setState(_))
											      : (t._emitToken({ type: 'Characters', data: i }), t.setState(_)),
										!0
									)
								}
								function P(e) {
									...
									return (
										i === r.EOF
											? (t._parseError('eof-in-script'), e.unget(i), t.setState(n))
											: i === '-'
											  ? (t._emitToken({ type: 'Characters', data: '-' }), e.commit())
											  : i === '<'
											    ? (t._emitToken({ type: 'Characters', data: '<' }), t.setState(H))
											    : i === '>'
											      ? (t._emitToken({ type: 'Characters', data: '>' }), t.setState(p))
											...
											: o(i)
											  ...
											  : i === '!'
											    ...
											    : i === '/'
											      ? t.setState(F)
											      : i === '>'
											        ? (t._parseError('expected-tag-name-but-got-right-bracket'),
											          t._emitToken({ type: 'Characters', data: '<>' }),
											          t.setState(n))
											        : i === '?'
											          ? (t._parseError('expected-tag-name-but-got-question-mark'),
											            e.unget(i),
											            t.setState(Q))
									...
									return (
										i === r.EOF
											? (t._parseError('expected-closing-tag-but-got-eof'),
											  ...
											  t.setState(n))
											: o(i)
											  ? ((t._currentToken = { type: 'EndTag', name: i.toLowerCase(), data: [] }),
											    t.setState(I))
											  : i === '>'
											    ? (t._parseError('expected-closing-tag-but-got-right-bracket'),
											      t.setState(n))
											    : (t._parseError('expected-closing-tag-but-got-char', { data: i }),
											      e.unget(i),
											      t.setState(Q)),
										!0
									)
								...
								function I(e) {
									...
									return (
										i === r.EOF
											? (t._parseError('eof-in-tag-name'), e.unget(i), t.setState(n))
											: s(i)
											  ? t.setState(q)
											  : o(i)
								...
								function q(e) {
									var i = e.char()
									if (i === r.EOF)
										t._parseError('expected-attribute-name-but-got-eof'), e.unget(i), t.setState(n)
									else {
										if (s(i)) return !0
										o(i)
											? (t._currentToken.data.push({ nodeName: i.toLowerCase(), nodeValue: '' }),
											  t.setState(R))
											: i === '>'
											  ? t._emitCurrentToken()
											  : i === '/'
											    ...
											    : i === "'" || i === '"' || i === '=' || i === '<'
											      ? (t._parseError('invalid-character-in-attribute-name'),
											        t._currentToken.data.push({ nodeName: i, nodeValue: '' }),
											        t.setState(R))
											      : i === '\0'
											        ? (t._parseError('invalid-codepoint'),
											          t._currentToken.data.push({ nodeName: '\ufffd', nodeValue: '' }))
											        : (t._currentToken.data.push({ nodeName: i, nodeValue: '' }),
											          t.setState(R))
									}
									return !0
								...
								function R(e) {
									var i = e.char(),
										...
										a = !1
									i === r.EOF
										? (t._parseError('eof-in-attribute-name'), e.unget(i), t.setState(n), (a = !0))
										: i === '='
										  ? t.setState(z)
										  : o(i)
										    ? ((t._currentAttribute().nodeName += i.toLowerCase()), (u = !1))
										    : i === '>'
										      ? (a = !0)
										      : s(i)
										        ? t.setState(U)
									...
									if (u) {
										...
										for (var c = f.length - 2; c >= 0; c--)
											if (l.nodeName === f[c].nodeName) {
												t._parseError('duplicate-attribute', { name: l.nodeName }),
													(l.nodeName = null)
												break
											}
								...
								function U(e) {
									var i = e.char()
									if (i === r.EOF)
										t._parseError('expected-end-of-tag-but-got-eof'), e.unget(i), t.setState(n)
									else {
										if (s(i)) return !0
										i === '='
											? t.setState(z)
											: i === '>'
											  ...
											  : o(i)
											    ...
											    : i === '/'
											      ? t.setState(K)
											      : i === "'" || i === '"' || i === '<'
											        ? (t._parseError('invalid-character-after-attribute-name'),
											          t._currentToken.data.push({ nodeName: i, nodeValue: '' }),
											          t.setState(R))
											        : i === '\0'
											          ? (t._parseError('invalid-codepoint'),
								...
								function z(e) {
									var i = e.char()
									if (i === r.EOF)
										t._parseError('expected-attribute-value-but-got-eof'), e.unget(i), t.setState(n)
									else {
										if (s(i)) return !0
										i === '"'
											? t.setState(W)
											: i === '&'
											  ...
											  : i === "'"
											    ? t.setState(X)
											    : i === '>'
											      ? (t._parseError('expected-attribute-value-but-got-right-bracket'),
											        t._emitCurrentToken())
											      : i === '=' || i === '<' || i === '`'
											        ? (t._parseError('unexpected-character-in-unquoted-attribute-value'),
								...
								function W(e) {
									var i = e.char()
									if (i === r.EOF)
										t._parseError('eof-in-attribute-value-double-quote'), e.unget(i), t.setState(n)
									else if (i === '"') t.setState(J)
									else if (i === '&') (this._additionalAllowedCharacter = '"'), t.setState($)
									else if (i === '\0')
										t._parseError('invalid-codepoint'),
											(t._currentAttribute().nodeValue += '\ufffd')
									else {
											...
											: i === "'"
											  ...
											  : i === '&'
											    ...
											    : i === '\0'
											      ? (t._parseError('invalid-codepoint'),
											        (t._currentAttribute().nodeValue += '\ufffd'))
											      : (t._currentAttribute().nodeValue += i + e.matchUntil("\0|['&]")),
										!0
									)
								}
								function V(e) {
									var i = e.char()
									if (i === r.EOF)
										t._parseError('eof-after-attribute-value'), e.unget(i), t.setState(n)
										...
										o === r.EOF &&
											(t._parseError('eof-in-attribute-value-no-quotes'), t._emitCurrentToken()),
											e.commit(),
								...
								function $(e) {
									...
									return (
										...
										this._additionalAllowedCharacter === '"'
											...
											: this._additionalAllowedCharacter === "'"
											  ? t.setState(X)
											  : this._additionalAllowedCharacter === '>' && t.setState(V),
										!0
									)
								}
								function J(e) {
										...
										i === r.EOF
											...
											: s(i)
											  ...
											  : i === '>'
											    ...
											    : i === '/'
											      ? t.setState(K)
											      : (t._parseError('unexpected-character-after-attribute-value'),
											        e.unget(i),
											        t.setState(q)),
										!0
									)
									...
									return (
										i === r.EOF
											? (t._parseError('unexpected-eof-after-solidus-in-tag'),
											  ...
											  t.setState(n))
											: i === '>'
											  ? ((t._currentToken.selfClosing = !0), t.setState(n), t._emitCurrentToken())
											  : (t._parseError('unexpected-character-after-solidus-in-tag'),
											    e.unget(i),
											    t.setState(q)),
										!0
									)
								...
								function G(e) {
									var n = e.shift(2)
									if (n === '--') (t._currentToken = { type: 'Comment', data: '' }), t.setState(Z)
									else {
										var i = e.shift(5)
										if (i === r.EOF || n === r.EOF)
											return (
												t._parseError('expected-dashes-or-doctype'), t.setState(Q), e.unget(n), !0
											)
										;(n += i),
											n.toUpperCase() === 'DOCTYPE'
												? ((t._currentToken = {
												  ...
												  t.setState(st))
												: t._tokenHandler.isCdataSectionAllowed() && n === '[CDATA['
												  ? t.setState(Y)
												  : (t._parseError('expected-dashes-or-doctype'), e.unget(n), t.setState(Q))
									}
									return !0
								}
								function Y(e) {
									...
									return (
										i === r.EOF
											...
											: i === '-'
											  ? t.setState(nt)
											  : i === '\0'
											    ? (t._parseError('invalid-codepoint'), (t._currentToken.data += '\ufffd'))
											...
											: i === '-'
											  ...
											  : i === '\0'
											    ? (t._parseError('invalid-codepoint'),
											      (t._currentToken.data += '-\ufffd'),
											      t.setState(tt))
											    : ((t._currentToken.data += '-' + i + e.matchUntil('\0|-')), e.char()),
										!0
									)
								}
								function rt(e) {
									...
									return (
										i === r.EOF
											...
											: i === '>'
											  ...
											  : i === '!'
											    ? (t._parseError('unexpected-bang-after-double-dash-in-comment'),
											      t.setState(it))
											    : i === '-'
											      ? (t._parseError('unexpected-dash-after-double-dash-in-comment'),
								...
								function st(e) {
									...
									return (
										i === r.EOF
											...
											: s(i)
											  ? t.setState(ot)
											  : (t._parseError('need-space-after-doctype'), e.unget(i), t.setState(ot)),
										!0
									)
								}
								function ot(e) {
									...
									return (
										i === r.EOF
											...
											: s(i) ||
											  (i === '>'
													? (t._parseError('expected-doctype-name-but-got-right-bracket'),
													  (t._currentToken.forceQuirks = !0),
													  t.setState(n),
													  t._emitCurrentToken())
													: (o(i) && (i = i.toLowerCase()),
											...
											e.unget(i),
												...
												i === r.EOF
													? (t._parseError('eof-in-doctype'),
													  ...
													  t.setState(n),
													  t._emitCurrentToken())
													: (t._parseError('expected-space-or-right-bracket-in-doctype', {
															data: i,
													  }),
													  t.setState(wt))
										}
									...
									return (
										i === r.EOF
											...
											: s(i) ||
											  (i === '>'
													? (t._emitCurrentToken(), t.setState(n))
													: (t._parseError('unexpected-char-in-doctype'), t.setState(wt))),
										!0
									)
								}
								function wt(e) {
						...
						function g() {
							...
							;(t.base = {
										...
										(r != null &&
											...
											: n != null &&
											  ...
											  : (n == '-//W3C//DTD HTML 4.0//EN' &&
											    ...
											    (((r != null && r != 'about:legacy-compat') || n != null) &&
								...
								(t.afterFrameset.processCharacters = function (t) {
									...
									r && e.insertText(r),
										r.length < n.length && e.parseError('expected-eof-but-got-char')
								}),
								...
								(t.inHead.processEOF = function () {
									...
									;['title', 'style', 'script'].indexOf(t) != -1 &&
										(e.parseError('expected-named-closing-tag-but-got-eof', { name: t }),
										e.popElement()),
										this.anythingElse(),
										e.insertionMode.processEOF()
								}),
								...
								(t.inBody.processCharacters = function (t) {
									e.shouldSkipLeadingNewline &&
										((e.shouldSkipLeadingNewline = !1), t.skipAtMostOneLeadingNewline()),
								...
								(t.inBody.startTagBody = function (t, n) {
									e.parseError('unexpected-start-tag', { name: 'body' }),
										e.openElements.length == 1 || e.openElements.item(1).localName != 'body'
											? r.ok(e.context)
											: ((e.framesetOk = !1),
											  e.addAttributesToElement(e.openElements.bodyElement, n))
								}),
								(t.inBody.startTagFrameset = function (t, n) {
									e.parseError('unexpected-start-tag', { name: 'frameset' })
									if (e.openElements.length == 1 || e.openElements.item(1).localName != 'body')
										r.ok(e.context)
										...
										!n || !e.openElements.inScope(t)
											...
											: (e.generateImpliedEndTags(),
											  e.currentStackItem() != n &&
													e.parseError('end-tag-too-early-ignored', { name: 'form' }),
								...
								(t.inCaption.endTagCaption = function (t) {
									e.openElements.inTableScope('caption')
										? (e.generateImpliedEndTags(),
										  ...
										  e.clearActiveFormattingElements(),
										  e.setInsertionMode('inTable'))
										: (r.ok(e.context), e.parseError('unexpected-end-tag', { name: t }))
								}),
								...
								(t.inTable.startTagForm = function (t, n) {
									e.parseError('unexpected-form-in-table'),
										e.form ||
											(e.insertElement(t, n), (e.form = e.currentStackItem()), e.openElements.pop())
								}),
								...
								(t.inSelect.endTagTableElements = function (t) {
									e.parseError('unexpected-end-tag-in-select', { name: t }),
										e.openElements.inTableScope(t) &&
											(this.endTagSelect('select'), e.insertionMode.processEndTag(t))
								}),
								...
								(t.inSelectInTable.endTagTable = function (t) {
									e.parseError('unexpected-table-element-end-tag-in-select-in-table', { name: t }),
										e.openElements.inTableScope(t) &&
											(this.endTagOther('select'), e.insertionMode.processEndTag(t))
								}),
								...
								(t.afterAfterFrameset.processCharacters = function (t) {
									...
									r && (e.reconstructActiveFormattingElements(), e.insertText(r)),
										r.length < n.length && e.parseError('expected-eof-but-got-char')
								}),
						...
						;(m.prototype.skipAtMostOneLeadingNewline = function () {
							...
							(m.prototype.takeLeadingWhitespace = function () {
								...
								return (
									...
									e === this.current ? '' : this.characters.substring(e, this.current - e)
								)
							}),
							...
							(g.prototype.adoptionAgencyEndTag = function (e) {
								...
								while (s++ < t) {
									...
									if (
										!r ||
										(this.openElements.contains(r) && !this.openElements.inScope(r.localName))
									)
									...
									while (d++ < n) {
										...
										;(this.activeFormattingElements[this.activeFormattingElements.indexOf(c)] = m),
											(this.openElements.elements[this.openElements.elements.indexOf(c)] = m),
											(c = m),
							...
							(g.prototype.processToken = function (e) {
								...
								(t.isMathMLTextIntegrationPoint() &&
									((e.type == 'StartTag' && !(e.name in { mglyph: 0, malignmark: 0 })) ||
										e.type === 'Characters')) ||
							...
							(g.prototype.insertHeadElement = function (e) {
								...
								return (
									(this.head = new f('http://www.w3.org/1999/xhtml', 'head', e, t)),
							...
							(g.prototype.shouldFosterParent = function () {
								return (
									this.redirectAttachToFosterParent && this.currentStackItem().isFosterParenting()
								)
							}),
							...
							(g.prototype.reconstructActiveFormattingElements = function () {
								...
								for (;;) {
									...
									if (n == this.activeFormattingElements[this.activeFormattingElements.length - 1])
										break
								}
							}),
								...
								for (var n = this.openElements.length - 1; n >= 0; n--) {
									;(t = this.openElements.item(n)),
										n === 0 &&
											(r.ok(this.context),
											(e = !0),
											(t = new f('http://www.w3.org/1999/xhtml', this.context, [], null)))
								...
								return (
									e.forEach(function (e) {
										;(e.namespaceURI = 'http://www.w3.org/2000/svg'),
											s.SVGAttributeMap[e.nodeName] && (e.nodeName = s.SVGAttributeMap[e.nodeName])
									}),
									e
								)
							}),
