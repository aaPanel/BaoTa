ace.define(
				...
				s = function (e) {
					...
					;(this.$rules = {
						...
						processing_instruction: [
							{ token: 'entity.other.attribute-name.decl-attribute-name.xml', regex: t },
	...
	ace.define(
		...
		['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/php_highlight_rules'],
		function (e, t, n) {
			'use strict'
			var r = e('../lib/oop'),
					...
					var e = {
							...
							parenthesis: [
								{
									...
									regex: '\\(',
									push: [
										{ token: 'parenthesis.end.blade', regex: '\\)', next: 'pop' },
										{ include: 'strings' },
										{ include: 'variables' },
										{ include: 'lang' },
										{ include: 'parenthesis' },
							...
							directives: [
								...
								},
								{
									...
									regex: '(@?)(\\{\\{)',
									push: [
										{ token: 'injections.end.blade', regex: '\\}\\}', next: 'pop' },
										{ include: 'strings' },
										{ include: 'variables' },
										{ defaultToken: 'source.blade' },
									],
								},
								{
									...
									regex: '\\{\\!\\!',
									push: [
										{ token: 'injections.unescaped.end.blade', regex: '\\!\\!\\}', next: 'pop' },
										{ include: 'strings' },
										{ include: 'variables' },
										{ defaultToken: 'source.blade' },
									],
							...
							strings: [
								{
									...
									regex: '"',
									push: [
										{ token: 'punctuation.definition.string.end.blade', regex: '"', next: 'pop' },
							...
							variables: [
								{ token: 'variable.blade', regex: '\\$([a-zA-Z_][a-zA-Z0-9_]*)\\b' },
								{
		...
		;(function () {
			;(this.getCompletions = function (e, t, n, r) {
				...
				(this.getArrayKeyCompletions = function (e, t, n, r) {
					...
					var u = []
					return (
						i[o].type === 'array' && i[o].value && (u = Object.keys(i[o].value)),
						u.map(function (e) {
								...
								if (f && f.type.indexOf('tag-close') !== -1) {
									...
									if (this.voidElements && !this.voidElements[l]) {
										var h = r.getTokenAt(o.row, o.column + 1),
											...
											d = p + r.getTabString()
										return h && h.value === '</'
											? { text: '\n' + d + '\n' + p, selection: [1, d.length, 1, d.length] }
											: { text: '\n' + d }
									}
								}
							}
			...
			;(function () {
				;(this.getFoldWidget = function (e, t, n) {
					...
					(this.getFoldWidgetRange = function (e, t, n) {
						...
						if (!r)
							return (
								this.getCommentFoldWidget(e, n) && e.getCommentFoldRange(n, e.getLine(n).length)
							)
			...
			;(function () {
				;(this.getCompletions = function (e, t, n, r) {
					...
					(this.getAttributeValueCompletions = function (e, t, n, r) {
						...
						var o = []
						return (
							i in u && s in u[i] && typeof u[i][s] == 'object' && (o = Object.keys(u[i][s])),
							o.map(function (e) {
				...
				function () {
					;(this.blockComment = { start: '<!--', end: '-->' }),
						...
						(this.createWorker = function (e) {
							...
							return (
								t.attachToDocument(e.getDocument()),
								this.fragmentContext && t.call('setOptions', [{ context: this.fragmentContext }]),
			...
			r.inherits(g, i),
				function () {
					;(this.tokenRe = new RegExp('^[' + p.wordChars + '_]+', 'g')),
						(this.nonTokenRe = new RegExp('^(?:[^' + p.wordChars + '_]|\\s])+', 'g')),
						(this.lineCommentStart = ['//', '#']),
						(this.blockComment = { start: '/*', end: '*/' }),
						(this.getNextLineIndent = function (e, t, n) {
							var r = this.$getIndent(t),
	...
	ace.define(
		...
		function (e, t, n) {
			'use strict'
			var r = e('../lib/oop'),
				i = e('./php_laravel_blade_highlight_rules').PHPLaravelBladeHighlightRules,
				s = e('./php').Mode,
				o = e('./javascript').Mode,
				u = e('./css').Mode,
				a = e('./html').Mode,
