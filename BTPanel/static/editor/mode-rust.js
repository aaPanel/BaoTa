	...
	function (e, t, n) {
		...
		var r = e('../lib/oop'),
			...
			o = function () {
				;(this.$rules = {
					start: [
						{ token: 'variable.other.source.rust', regex: "'[a-zA-Z_][a-zA-Z0-9_]*(?![\\'])" },
						...
						},
						{
							...
							regex: '"',
							push: [
								{ token: 'string.quoted.double.source.rust', regex: '"', next: 'pop' },
						...
						{ token: 'comment.line.double-dash.source.rust', regex: '//.*$' },
						{
							...
							stateName: 'comment',
							push: [
								{ token: 'comment.start.block.source.rust', regex: '/\\*', push: 'comment' },
								{ token: 'comment.end.block.source.rust', regex: '\\*/', next: 'pop' },
