    ...
    var Public = (function (_super) {
        ...
        Public.prototype.renderLoginAlarmLine = function (config) {
            ...
            if (isChannel && isSetEmail) {
                setAlarmMail.text('邮箱已设置').removeClass('bt_warning').addClass('btlink');
                interval.hide();
                setAlarmNailNail.hide();
            }
            else if (isChannel && isSetdingding) {
                setAlarmNailNail.text('钉钉/企业微信已设置').removeClass('bt_warning').addClass('btlink');
                interval.hide();
                setAlarmMail.hide();
            }
            else {
                            ...
                            return [4, this.$open({
                                ...
                                success: function (layers, indexs) {
                                    ...
                                    $(".SetChannelEmail").click(function () { return __awaiter(_this_1, void 0, void 0, function () {
                                        var email, stmp_pwd, hosts, port, portSelectVal, rdata_1, err_2;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
