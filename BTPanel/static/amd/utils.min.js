...
define("public/vdom", ["require", "exports", "snabbdom"], function (require, exports, snabbdom_1) {
    ...
    var Vm = (function () {
        function Vm(config) {
            ...
            this.$watcher({
                ...
                watch: function (key, oldVal, newVal) {
                    ...
                    console.log(key, oldVal, newVal, '测试数据监听');
                }
            });
            this.$eventHandle();
        ...
        Vm.prototype.$inputEvent = function (ev, fn) {
            ...
            console.log(ev, name, targetValue);
    ...
    var Utils = (function () {
        ...
        Utils.prototype.$confirm = function (param) {
            return new Promise(function (resolve, reject) {
                ...
                }, param), function (indexs) { return resolve(indexs); }, function (indexs) { return reject({ cancel: true }); });
            });
        };
    ...
    var Public = (function (_super) {
        ...
        function Public() {
            ...
            _this_1.apiInfo = {
                ...
                'bindBtAccount': ['ssl/GetToken', '绑定宝塔账号'],
                                    ...
                                    content: {
                                        ...
                                        template: function () {
                                            return (0, snabbdom_2.jsx)("div", { class: this.$class('pd20 bt-form libLogin') },
                                                (0, snabbdom_2.jsx)("h4", { class: this.$class('c2 f18 text-center mtb20') }, "\u7ED1\u5B9A\u5B9D\u5854\u5B98\u7F51\u8D26\u53F7"),
                                                (0, snabbdom_2.jsx)("div", { class: { "line": true } }, this.$input({ model: 'username', placeholder: '手机' })),
                                                (0, snabbdom_2.jsx)("div", { class: { "line": true } }, this.$input({ model: 'password', type: 'password', placeholder: '密码', keyup: this.bindUserInfo.bind(this) })),
                                        ...
                                        methods: {
                                            bindUserInfo: function (ev) {
                                                return __awaiter(this, void 0, void 0, function () {
                                                    var _a, username, password, rdata;
                                                    return __generator(this, function (_b) {
                                                        switch (_b.label) {
                                                            case 0:
                                                                ...
                                                                return [4, that_1.$verifySubmitList([[!username, '请输入手机号'], [!password, '请输入密码']])];
                                                            case 1:
                                                                _b.sent();
                                                                return [4, that_1.$request('bindBtAccount', { username: username, password: password })];
                                                            case 2:
                                                                rdata = _b.sent();
                                                                rdata.status && that_1.$refreshBrowser();
                                                                return [2];
                                                        }
                                                    });
                                                });
        ...
        Public.prototype.setMessageChannelView = function (type) {
        ...
        Public.prototype.setMailMessageView = function () {
            return __awaiter(this, void 0, void 0, function () {
                            ...
                            return [4, this.$open({
                                    ...
                                    success: function (layers, indexs) {
                                        ...
                                        $(".SetChannelEmail").click(function () { return __awaiter(_this_1, void 0, void 0, function () {
                                            var email, stmp_pwd, hosts, port, portSelectVal, rdata;
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                    ...
                                                    case 2:
                                                        rdata = _a.sent();
                                                        rdata.status && layer.close(indexs);
                                                        return [2];
                                                }
                                            });
                                        }); });
                                        ...
                                        $('.set_empty').click(function () { return __awaiter(_this_1, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4, _that_1.$request(['config/set_empty', '清空邮箱发送者设置'], { type: 'mail' })];
                                                    case 1:
                                                        rdata = _a.sent();
                                                        rdata.status && layer.close(indexs);
                                                        return [2];
