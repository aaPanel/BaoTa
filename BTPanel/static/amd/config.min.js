                        ...
                        case 0:
                            ...
                            return [4, this.$open({
                                    ...
                                    content: {
                                        ...
                                        template: function () {
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('pd20 bt-form') }, this.$line({ title: '密码过期时间' }, this.$input({ model: 'expire', placeholder: '请输入面板安全入口', width: '240px' })));
                                        }
                                    },
                                    yes: function (content) { return __awaiter(_this, void 0, void 0, function () {
