                                        ...
                                        methods: {
                                            saveSslVerify: function () {
                                                return __awaiter(this, void 0, void 0, function () {
                                                    ...
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0: return [4, that_2.$verifySubmitList([
                                                                    [!this.ca, '注销列表(crl)不能为空'],
                                                                    [!this.crl, '证书(cert)不能为空'],
                                                                ])];
                                                            case 1:
                                                                _a.sent();
                                                                return [4, that_2.$request('setSslVerify', { crl: this.crl, ca: this.ca, status: 0 })];
                                                            case 2:
                                                                rdata = _a.sent();
                                                                return [4, that_2.$request('restartPanel', false)];
                                                            case 3:
                                                                _a.sent();
                                                                rdata.status && that_2.$refreshBrowser();
                                                                return [2];
                                                        }
                                                    });
                                                });
