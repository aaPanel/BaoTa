...
define(["require", "exports", "./snabbdom", "./public/public"], function (require, exports, snabbdom_1, public_1) {
    ...
    var Config = (function (_super) {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [4, this.$open({
                                    ...
                                    skin: 'panel-ssl',
                                    content: {
                                        data: { cert_type: certSource.cert_type || 1, email: '', certPem: !download_root ? certPem : '', privateKey: !download_root ? privateKey : '', agreement: false },
                                        template: function () {
        ...
        Config.prototype.setAlarmView = function (config) {
            return __awaiter(this, void 0, void 0, function () {
                var channelInfo, login_alarm_info, isEmail, isDing, rdata, _a, mail, dingding, error_13;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                                    ...
                                    success: function () { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            ...
                                            $('#mail_alarm,#dingding_alarm').on('click', function (ev) { return __awaiter(_this, void 0, void 0, function () {
                                                var that, checked, type, name_1, error_14;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 8:
                            ...
                            menuHideList = $('[name="menu_hide_list"]'), statusCode = $('[name="status_code"]');
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    $('input[type="checkbox"]').on('change', function (ev) { return __awaiter(_this, void 0, void 0, function () {
                        var el, _a, name, checked, status, config, _b, rdata, error_17;
                        var _this = this;
