...
define(["require", "exports", "./snabbdom", "./public/public"], function (require, exports, snabbdom_1, public_1) {
    ...
    var Config = (function (_super) {
                                ...
                                content: {
                                    ...
                                    template: function () {
                                        return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                            ...
                                            this.$learnMore({ title: '我已了经解详情，并愿意承担风险，开启开发模式', model: 'agreement', id: 'checkDevelopers' }));
                                    }
                                },
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                                ...
                                                if (!vm.agreement)
                                                    return [2, this.$tips({ msg: '请勾选，已了解风险选项', el: '#checkDevelopers' })];
                            ...
                            return [4, this.$open({
                                    ...
                                    content: {
                                        ...
                                        template: function () {
                                            ...
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                                this.$line({ title: 'API接口', width: lineWidth }, this.$switch({ model: 'api', change: this.setPanelApi.bind(this) })),
                                                this.$line({ title: '接口密钥', width: lineWidth }, this.$box(this.$input({ model: 'panelTokenValue', disabled: true, style: { width: '310px' } }), this.$button({ size: 'xs', click: this.resetInterface.bind(this), style: 'margin-left:-50px;', title: '重置' }))),
                                                this.$line({ title: (0, snabbdom_1.jsx)("span", null,
                                                        "IP\u767D\u540D\u5355",
                                                        (0, snabbdom_1.jsx)("br", null),
                                                        "(\u6BCF\u884C1\u4E2A)"), width: lineWidth, style: 'overflow: initial;height:20px;line-height:20px;' }, this.$textarea({ model: 'apiLimitAddr', style: 'width: 310px;height:80px;line-height: 20px;padding: 5px 8px;' })),
                                                this.$line({ title: '', width: lineWidth }, this.$button({ size: 'sm', click: this.savePanelApiIp.bind(this), title: '保存' })),
                                        ...
                                        methods: {
                                            ...
                                            resetInterface: function () {
                                                return __awaiter(this, void 0, void 0, function () {
                                                    ...
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0: return [4, that.$confirm({ title: '重置密钥', msg: '您确定要重置当前密钥吗？<br><span style="color: red; ">重置密钥后，已关联密钥产品，将失效，请重新添加新密钥至产品。</span>' })];
                                                            case 1:
                                                                _a.sent();
                                                                return [4, that.$request('setToken', { t_type: 1 }, false)];
                                                            case 2:
                                                                rdata = _a.sent();
                                                                that.$msg({ msg: '接口密钥已生成，重置密钥后，已关联密钥产品，将失效，请重新添加新密钥至产品。', time: 0, closeBtn: 2 });
                            ...
                            return [4, this.$open({
                                    ...
                                    content: {
                                        ...
                                        template: function () {
                                            ...
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                                this.$line({ title: '用户名', width: lineWidth }, this.$input({ model: 'username1', width: inputWidth })),
                                                this.$line({ title: '重复', width: lineWidth }, this.$input({ model: 'username2', width: inputWidth })));
                                        }
                                    },
                                    yes: function (config) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    content: {
                                        ...
                                        template: function () {
                                            ...
                                            return (0, snabbdom_1.jsx)("div", { class: { 'bt-form': true, 'pd25': true } },
                                                this.$line({ title: '密码', width: lineWidth }, this.$box(this.$input({ model: 'password1', width: inputWidth }), this.$icon({ type: 'repeat', click: this.showPaw.bind(this), class: 'ml5' }))),
                                                this.$line({ title: '重复', width: lineWidth }, this.$input({ model: 'password2', width: inputWidth })));
                                        },
                                        methods: {
                                            showPaw: function () {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [4, this.$open({
                                    ...
                                    skin: 'panel-ssl',
                                    content: {
                                        data: { cert_type: 1, email: certSource.email || '', certPem: !download_root ? certPem : '', privateKey: !download_root ? privateKey : '', agreement: false },
                                        template: function () {
                                            ...
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                                ...
                                                (0, snabbdom_1.jsx)("div", { class: { pt10: true } },
                                                    this.$line({ title: '类型', width: lineWidth }, this.$select({ model: 'cert_type', width: inputWidth, options: [{ label: '自签证书', value: 1 }, { label: 'Let\'s Encrypt', value: 2 }, { label: '其他证书', value: 0 }], change: this.changeCertType.bind(this) })),
                                                    this.$line({ title: '邮箱', width: lineWidth, hide: !(this.cert_type == 2) }, this.$input({ model: 'email', width: inputWidth })),
                                                    this.$line({ title: '密钥(KEY)', width: lineWidth, hide: !(this.cert_type == 0) }, this.$textarea({ model: 'privateKey', width: inputWidth, height: '80px', style: 'line-height: 16px;padding: 5px 8px;' })),
                                                    this.$line({ title: '证书(PEM)', width: lineWidth, hide: !(this.cert_type == 0) }, this.$textarea({ model: 'certPem', width: inputWidth, height: '80px', style: 'line-height: 16px;padding: 5px 8px;' })),
                                                    this.$learnMore({ model: 'agreement', id: 'checkSSL', style: 'margin-left:35px;', title: (0, snabbdom_1.jsx)("span", null,
                                                            "\u6211\u5DF2\u4E86\u7ECF\u89E3\u8BE6\u60C5,\u5E76\u613F\u610F\u627F\u62C5\u98CE\u9669",
                                                            this.$link({ title: '了解详情', className: 'mlr15', href: 'https://www.bt.cn/bbs/forum.php?mod=viewthread&tid=4689' })), })));
                                        },
                                        methods: {
                                            changeCertType: function () {
                                                if (!that.configInfo.domain && this.cert_type == 2) {
                                                    this.cert_type = 1;
                                                    return that.$msg({ icon: 2, msg: '当前面板未绑定域名，无法申请Let\'s Encrypt证书', time: 3000 });
                                                }
                                            }
                                        }
                                    },
        ...
        Config.prototype.setPanelSslConfigView = function () {
            return __awaiter(this, void 0, void 0, function () {
                var that, _a, certPem, privateKey, download_root, info, root_password, error_4;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            that = this;
                            return [4, this.$request('getPanelSsl')];
                        case 1:
                            _a = _b.sent(), certPem = _a.certPem, privateKey = _a.privateKey, download_root = _a.download_root, info = _a.info, root_password = _a.root_password;
                            _b.label = 2;
                        case 2:
                            _b.trys.push([2, 4, , 5]);
                            return [4, this.$open({
                                    ...
                                    area: ['700px', '640px'],
                                    content: {
                                        data: { certPem: certPem, privateKey: privateKey, ssl: this.configInfo.ssl },
                                        template: function () {
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                                (0, snabbdom_1.jsx)("div", { class: this.$class('alert alert-success') },
                                                    (0, snabbdom_1.jsx)("div", { style: { display: 'inline-block', 'margin-right': '30px' } },
                                                        "\u8BA4\u8BC1\u57DF\u540D\uFF1A",
                                                        (0, snabbdom_1.jsx)("span", { style: { 'font-weight': '700' } }, info.dns.join('、'))),
                                                    (0, snabbdom_1.jsx)("div", { style: { display: 'inline-block', 'margin-right': '30px' } },
                                                        "\u8BC1\u4E66\u54C1\u724C\uFF1A",
                                                        (0, snabbdom_1.jsx)("span", { style: { 'font-weight': '700' } }, info.issuer)),
                                                    (0, snabbdom_1.jsx)("div", { style: { display: 'inline-block', 'margin-right': '30px' } },
                                                        "\u5230\u671F\u65F6\u95F4\uFF1A",
                                                        (0, snabbdom_1.jsx)("span", { style: { 'font-weight': '700' } }, info.notAfter))),
                                                (0, snabbdom_1.jsx)("div", { class: { 'hide': !download_root, 'pt10': true }, style: { clear: 'both' } },
                                                    (0, snabbdom_1.jsx)("span", { style: { 'margin-right': '5px' } }, "\u6E29\u99A8\u63D0\u793A\uFF1A\u5F53\u524D\u8BC1\u4E66\u4E3A\u81EA\u7B7E\u8BC1\u4E66\uFF0C\u9700\u8981\u5B89\u88C5\u672C\u5730\u6839\u8BC1\u4E66\uFF0C"),
                                                    (0, snabbdom_1.jsx)("a", { props: { href: '/download?filename=/www/server/panel/ssl/baota_root.pfx', target: "_blank" }, class: this.$class('btn btn-success btn-xs mr10') }, "\u4E0B\u8F7D\u6839\u8BC1\u4E66"),
                                                    (0, snabbdom_1.jsx)("span", null,
                                                        "\u8BC1\u4E66\u5BC6\u7801\uFF1A",
                                                        (0, snabbdom_1.jsx)("input", { props: { type: 'text', value: root_password }, style: { 'height': '25px', 'line-height': '25px' }, class: { "bt-input-text": true } }),
                                                ...
                                                this.$line({ title: '面板SSL', width: '65px' }, this.$switch({ model: 'ssl', change: this.setPanelSsl.bind(this) })),
                                                (0, snabbdom_1.jsx)("div", { class: this.$class('myKeyCon ptb15') },
                                                    ...
                                                    (0, snabbdom_1.jsx)("div", { class: this.$class('ssl-btn pull-left mt10'), style: { width: "100%" } }, this.$button({ title: '保存', click: this.savePanelSsl.bind(this) }))),
                                                this.$ul({ style: 'clear:both; padding-top:10px;' }, [
                                                    [(0, snabbdom_1.jsx)("span", null,
                                                            "\u7C98\u8D34\u60A8\u7684*.key\u4EE5\u53CA*.pem\u5185\u5BB9\uFF0C\u7136\u540E\u4FDD\u5B58\u5373\u53EF",
                                                            this.$link({ title: '帮助', href: 'http://www.bt.cn/bbs/thread-704-1-1.html' }),
                                                            "\u3002")],
                                            ...
                                            return __awaiter(this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 1:
                                                            param = _a.sent();
                                                            document.getElementById('copyRootPassword').setAttribute('data-clipboard-text', root_password);
                                                    ...
                                                    return __generator(this, function (_b) {
                                                        switch (_b.label) {
                                                            case 0:
                                                                ...
                                                                return [4, that.$request('setPanelSsl', { cert_type: '0', privateKey: privateKey_1, certPem: certPem_1 })];
                                                            case 1:
                                                                _b.sent();
                                                ...
                                                content: {
                                                    ...
                                                    template: function () {
                                                        return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                                            ...
                                                            this.$learnMore({ title: (0, snabbdom_1.jsx)("span", null,
                                                                    "\u6211\u5DF2\u7ECF\u4E86\u89E3\u8BE6\u60C5,\u5E76\u613F\u610F\u627F\u62C5\u98CE\u9669  ",
                                                                    this.$link({ title: '什么是BasicAuth认证？', href: 'https://www.bt.cn/bbs/thread-34374-1-1.html' })), model: 'agreement', id: 'checkBasicAuth' }));
                                                    }
                                                },
                                                yes: function (config) { return __awaiter(_this, void 0, void 0, function () {
                                                    ...
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0:
                                                                close = config.close, vm = config.vm;
                                                                if (!vm.agreement)
                                                                    return [2, this.$tips({ el: '#checkBasicAuth', msg: '请阅读并同意承担风险' })];
                                                                close();
                                                                _a.label = 1;
                                                            case 1:
                                                                _a.trys.push([1, 3, , 4]);
                            ...
                            return [4, this.$open({
                                    ...
                                    content: {
                                        ...
                                        template: function () {
                                            ...
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                                this.$line({ title: '服务状态' }, this.$switch({ model: 'open', change: this.setBasicAuthConfig.bind(this) })),
                                                this.$line({ title: '用户名' }, this.$input({ model: 'basic_user', placeholder: '请设置用户名', width: inputWidth })),
                                                this.$line({ title: '密码' }, this.$input({ model: 'basic_pwd', placeholder: '请设置密码', width: inputWidth })),
                                                this.$line({ title: '' }, this.$button({ title: '保存配置', click: this.saveBasicAuth.bind(this) })),
                                                this.$ul([
                                        ...
                                        return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                            ...
                                            this.$ul({ className: 'explainDescribeList pd15' }, [
                                                ...
                                                [(0, snabbdom_1.jsx)("span", null,
                                                        ...
                                                        this.$link({ title: '查看详情', href: 'https://www.bt.cn/bbs/forum.php?mod=viewthread&tid=37437' }))],
                                            ]),
                                            ...
                                            this.$learnMore({ title: '我已安装APP和了解详情,并愿意承担风险！', model: 'agreement', id: 'checkAuthenticator' }));
                                    }
                                },
                                yes: function (config) { return __awaiter(_this, void 0, void 0, function () {
                                    var close, vm, rdata, _a;
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                                close = config.close, vm = config.vm;
                                                if (!vm.agreement)
                                                    return [2, this.$tips({ el: '#checkAuthenticator', msg: '请阅读并同意承担风险' })];
                                            ...
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                                ...
                                                this.$ul({ className: 'verify_tips' }, [
                                                    [(0, snabbdom_1.jsx)("span", null,
                                                            ...
                                                            this.$link({ title: '使用教程', href: 'https://www.bt.cn/bbs/forum.php?mod=viewthread&amp;tid=37437' }))],
                                            ...
                                            return __awaiter(this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 2:
                                                            _a.sent();
                                                            $('#verify_qrcode').qrcode({ render: "canvas", width: 150, height: 150, text: rdata });
                                                            return [2];
                                                    }
                                                });
                                            });
                                    ...
                                    content: {
                                        ...
                                        template: function () {
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                                ...
                                                this.$learnMore({ title: (0, snabbdom_1.jsx)("span", null,
                                                        "\u6211\u5DF2\u4E86\u7ECF\u89E3\u8BE6\u60C5,\u5E76\u613F\u610F\u627F\u62C5\u98CE\u9669\uFF01 ",
                                                        this.$link({ title: '了解详情', href: 'https://www.bt.cn/bbs/thread-77863-1-1.html' })), model: 'agreement', id: 'checkSslVerify' }));
                                        }
                                    },
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    ...
                                                    if (!vm.agreement)
                                                        return [2, this.$tips({ el: '#checkSslVerify', msg: '请阅读并同意承担风险' })];
                                                    return [4, this.$verifySubmitList([
                                                ...
                                                case 1:
                                                    _a.sent();
                                                    return [4, this.$request('setSslVerify', { crl: vm.crl, ca: vm.ca, status: 1 })];
                                                case 2:
                                                    rdata = _a.sent();
                                            ...
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('pd20') },
                                                (0, snabbdom_1.jsx)("div", { class: this.$class('myKeyCon ptb15') },
                                                    ...
                                                    (0, snabbdom_1.jsx)("div", { class: this.$class('ssl-con-key pull-left'), style: { width: '48%' } },
                                                        ...
                                                        (0, snabbdom_1.jsx)("br", null),
                                                        this.$textarea({ model: 'ca' })),
                                                    (0, snabbdom_1.jsx)("div", { class: this.$class('ssl-btn pull-left mtb15'), style: { width: "100%" } }, this.$button({ title: '保存', click: this.saveSslVerify.bind(this) }))),
                                                ...
                                                return __awaiter(this, void 0, void 0, function () {
                                                    ...
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            ...
                                                            case 1:
                                                                _a.sent();
                                                                return [4, that.$request('setSslVerify', { crl: this.crl, ca: this.ca, status: 0 })];
                                                            case 2:
                                                                rdata = _a.sent();
                                                                return [4, that.$request('restartPanel', false)];
                                                            case 3:
                                    ...
                                    content: {
                                        ...
                                        template: function () {
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('pd20 bt-form') },
                                                ...
                                                this.$line({ title: '面板端口' }, this.$input({ model: 'port', placeholder: '请输入面板端口', width: '210px' })),
                                                this.$learnMore({ title: (0, snabbdom_1.jsx)("span", null,
                                                        "\u6211\u5DF2\u4E86\u89E3,",
                                                        this.$link({ title: '如何放行端口？', href: 'https://www.bt.cn/bbs/thread-40037-1-1.html' })), model: 'agreement', id: 'checkPanelPort' }));
                                        }
                                    },
                                    yes: function (content) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    ...
                                                    if (!vm.agreement)
                                                        return [2, this.$tips({ el: '#checkPanelPort', msg: '请勾选已了解，继续操作' })];
                                                    return [4, this.$verifySubmit(!this.$checkPort(port), '请输入正确的面板端口')];
                                                case 1:
                                                    _a.sent();
                        ...
                        case 0:
                            ...
                            return [4, this.$open({
                                    ...
                                    content: {
                                        ...
                                        template: function () {
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('pd20 bt-form') }, this.$line({ title: '安全入口' }, this.$input({ model: 'expire', placeholder: '请输入面板安全入口', width: '240px' })));
                                        }
                                    },
                                    yes: function (content) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        case 0:
                            ...
                            return [4, this.$open({
                                    ...
                                    content: {
                                        ...
                                        template: function () {
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('pd20 bt-form') },
                                                this.$line({ title: '密码过期时间' }, this.$box(this.$input({ model: 'expire', placeholder: '', width: '120px' }), (0, snabbdom_1.jsx)("span", null, "\u5929"))),
                                                this.$ul([
                                    ...
                                    yes: function (config) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    close = config.close, vm = config.vm;
                                                    return [4, this.$request('setRequestType', { http_type: vm.http_type })];
                                                case 1:
                                                    rdata = _a.sent();
                                                    rdata.status && close() && this.$refreshBrowser();
                                                    return [2];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            console.log(this.Info.request_iptype);
                            return [4, this.$open({
                                    title: '设置面板云端请求线路',
                                    area: ['420px', '180px'],
                                    btn: ['提交', '取消'],
                                    ...
                                    yes: function (config) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    close = config.close, vm = config.vm;
                                                    return [4, this.$request('setRequestIpType', { iptype: vm.iptype })];
                                                case 1:
                                                    rdata = _a.sent();
                                                    rdata.status && close() && this.$refreshBrowser();
                                                    return [2];
        ...
        Config.prototype.setAlarmView = function (config) {
            return __awaiter(this, void 0, void 0, function () {
                var channelInfo, login_alarm_info, isEmail, isDing, rdata, _a, mail, dingding, error_15;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            channelInfo = config.message_channel_info, login_alarm_info = config.login_alarm_info;
                            isEmail = channelInfo.user_mail.user_name, isDing = channelInfo.dingding.dingding;
                            if (!isEmail && !isDing)
                                return [2, this.$msg({ msg: '请在消息通道中设置一个通道', icon: 2 })];
                            ...
                            return [4, this.$open({
                                    ...
                                    success: function () { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            ...
                                            $('#mail_alarm,#dingding_alarm').on('click', function (ev) { return __awaiter(_this, void 0, void 0, function () {
                                                var that, checked, type, name_1, error_16;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            that = $(ev.target), checked = that.prop('checked'), type = that.attr('name');
                                                            if (type == 'mail' && !channelInfo.user_mail.user_name) {
                                                                that.prop('checked', !checked);
                                                                return [2, this.$error('未配置消息通道 [邮箱]')];
                                                            }
                                                            if (type == 'dingding' && !channelInfo.dingding.dingding) {
                                                                that.prop('checked', !checked);
                                                        ...
                                                        case 2:
                                                            ...
                                                            if (checked) {
                                                                if (type == 'mail') {
                                                                    ...
                                                                    $('#dingding_alarm').prop('checked', !checked);
                                                                }
                                                                else if (type == 'dingding') {
                                                                    login_alarm_info.mail = !checked;
                                                                    $('#mail_alarm').prop('checked', !checked);
                                                                }
                                                            }
                                            ...
                                            $('.add_ip_write').on('click', function () { return __awaiter(_this, void 0, void 0, function () {
                                                var ip_write, ip;
                                                var _this = this;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 1:
                                                            _a.sent();
                                                            return [4, this.$request(['config/login_ipwhite', '添加登录告警IP白名单'], { ip: ip, type: 'add' })];
                                                        case 2:
                                                            _a.sent();
                                                            rdata.status && setTimeout(function () { _this.reanderLoginIpTable(); }, 1000);
                                                            ip_write.val('');
                                                            return [2];
                                                    }
                                                });
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            ...
                                                            return [4, this.$confirm({ title: '删除IP白名单', msg: "\u5220\u9664IP\u767D\u540D\u5355[ ".concat(ip, " ]\uFF0C\u7EE7\u7EED\u64CD\u4F5C\uFF1F") })];
                                                        case 1:
                                                            _a.sent();
                                                            return [4, this.$request(['config/login_ipwhite', '删除IP白名单'], { ip: ip, type: 'del' })];
                                                        case 2:
                                                            _a.sent();
                                                            rdata.status && setTimeout(function () { _this.reanderLoginIpTable(); }, 1000);
                                                            return [2];
                                            ...
                                            $('.clear_all').on('click', function () { return __awaiter(_this, void 0, void 0, function () {
                                                var rdata;
                                                var _this = this;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4, this.$confirm({ title: '清空全部', msg: '清空全部IP白名单，继续操作？' })];
                                                        case 1:
                                                            _a.sent();
        ...
        Config.prototype.reanderLoginTable = function (p) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.$request(['config/get_login_log', '获取登录日志中'], { p: p })];
                        case 1:
                            rdata = _a.sent(), html = '';
                            $('#server_table').empty();
                            if (!rdata.data)
                            ...
                            for (i = 0; i < rdata.data.length; i++) {
                                item = rdata.data[i];
                                html += "<tr><td style=\"white-space: nowrap;\" title=\"".concat(item.log, "\">").concat(item.log, "</td></tr>");
                            }
        ...
        Config.prototype.reanderLoginIpTable = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.$request(['config/login_ipwhite', '获取IP白名单列表'], { type: 'get' })];
                        case 1:
                            rdata = _a.sent(), html = '';
                            ...
                            return [4, this.$open({
                                    ...
                                    success: function () {
                                        ...
                                        $('.create_temp_login').on('click', function () { return __awaiter(_this, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4, this.$confirm({ title: '风险提示', msg: '<span style="color:red">注意1：滥用临时授权可能导致安全风险。</br>注意2：请勿在公共场合发布临时授权连接</span></br>即将创建临时授权连接，继续吗？' })];
                                                    case 1:
                                                        _a.sent();
                                                        _a.label = 2;
                                                    case 2:
                                                                        ...
                                                                        switch (_a.label) {
                                                                            ...
                                                                            case 2:
                                                                                ...
                                                                                clipboards.on('error', function (ev) {
                                                                                    _this.$msg({ status: false, msg: '复制失败，请手动复制地址' });
                                                                                });
                                                                                return [2];
                                                                        }
                                                                    });
        ...
        Config.prototype.renderConfigData = function () {
            return __awaiter(this, void 0, void 0, function () {
                var loadT, configInfo, twoStep, sslVerify, pawComplexity, bindUserInfo, messageChannelInfo, loginAlarmInfo, getMenuList, data, username, webname, session_timeout, show_workorder, ssl_verify, sites_path, backup_path, systemdate, paw_complexity, paw_expire_time, check_two_step, bind_user_info, _a, port, admin_path, domain, limitip, address, key, item, el, type, menuHideList, statusCode, requestIpTypeVal, requestTypeVal, menuList, i, item, statusCodeList, statusCodeTips, i, item;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            loadT = this.$load('正在获取面板配置信息，请稍后...');
                            return [4, this.$request('getConfig', false)];
                        case 1:
                            configInfo = _b.sent();
                            return [4, this.$request('getCheckTwoStep', { loading: false, msg: false })];
                        case 2:
                            twoStep = _b.sent();
                            return [4, this.$request('getSslVerify', { loading: false, msg: false })];
                        case 3:
                            sslVerify = _b.sent();
                            return [4, this.$request('getPasswordConfig', { loading: false, msg: false })];
                        case 4:
                            pawComplexity = _b.sent();
                            return [4, this.$request('getUserInfo', { loading: false, msg: false })];
                        case 5:
                            bindUserInfo = _b.sent();
                            return [4, this.$request('getMessageChannel', { loading: false, msg: false })];
                        case 6:
                            messageChannelInfo = _b.sent();
                            return [4, this.$request('getLoginAlarm', { loading: false, msg: false })];
                        case 7:
                            loginAlarmInfo = _b.sent();
                            return [4, this.$request('getMenuList', { loading: false, msg: false })];
                        case 8:
                            getMenuList = _b.sent();
                            loadT.close();
                            this.Info = Object.assign(this.Info, configInfo, { check_two_step: twoStep.status, ssl_verify: sslVerify.status, paw_complexity: pawComplexity.password_safe, paw_expire_time: pawComplexity.expire, bind_user_info: bindUserInfo.data.username, message_channel_info: messageChannelInfo, login_alarm_info: loginAlarmInfo.msg, menu_list: getMenuList });
                            data = this.Info;
                            username = sessionInfo.username, webname = sessionInfo.title;
                            session_timeout = data.session_timeout, show_workorder = data.show_workorder, ssl_verify = data.ssl_verify, sites_path = data.sites_path, backup_path = data.backup_path, systemdate = data.systemdate, paw_complexity = data.paw_complexity, paw_expire_time = data.paw_expire_time, check_two_step = data.check_two_step, bind_user_info = data.bind_user_info;
                            _a = data.panel, port = _a.port, admin_path = _a.admin_path, domain = _a.domain, limitip = _a.limitip, address = _a.address;
                            this.formInfo = { webname: webname, session_timeout: session_timeout, domain: domain, limitip: limitip, sites_path: sites_path, backup_path: backup_path, address: address, systemdate: systemdate, port: port };
                            this.configInfo = {
                                close_panel: false,
                            ...
                            menuHideList = $('[name="menu_hide_list"]'), statusCode = $('[name="status_code"]'), requestIpTypeVal = $('[name="request_iptype"]'), requestTypeVal = $('[name="request_type"]');
                            ...
                            requestIpTypeVal.val(this.Info.request_iptype);
                            requestTypeVal.val(this.Info.request_type);
                            return [2];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                            ...
                            switch (_c.label) {
                                ...
                                case 1:
                                    ...
                                    switch (_b) {
                                        ...
                                        case 'is_local': return [3, 4];
                                        case 'debug': return [3, 5];
                                        case 'api': return [3, 9];
                                        case 'show_workorder': return [3, 10];
                                        case 'ssl': return [3, 11];
                                        case 'basic_auth': return [3, 15];
                                        case 'check_two_step': return [3, 19];
                                        case 'ssl_verify': return [3, 24];
                                        case 'paw_complexity': return [3, 29];
                                    }
                                    return [3, 30];
                                case 2:
                                    config = {
                                ...
                                case 4:
                                    config = {
                                        ...
                                        confirm: function () { return _this.$request('setLocal'); }
                                    };
                                    return [3, 30];
                                case 5:
                                ...
                                case 7:
                                    config = {
                                        ...
                                        confirm: function () { return _this.$request('setDebug'); }
                                    };
                                    _c.label = 8;
                                case 8: return [3, 30];
                                case 9:
                                    checked ? this.setPanelApiView(checked) : this.$request('setToken', { t_type: 2 });
                                    return [3, 30];
                                case 10:
                                    config = {
                                ...
                                case 17:
                                    config = {
                                        ...
                                        confirm: function () { return __awaiter(_this, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4, this.$request('setBasicAuth', { open: 'False', basic_user: '', basic_pwd: '' })];
                                                    case 1:
                                                        rdata = _a.sent();
                                                        rdata.status && this.$refreshBrowser();
                                                        return [2];
                                ...
                                case 20:
                                    _c.sent();
                                    return [3, 23];
                                case 21: return [4, this.$request('setTwoStepAuth', { act: 0 })];
                                case 22:
                                    _c.sent();
                                    _c.label = 23;
                                case 23: return [3, 30];
                                ...
                                case 25:
                                    _c.sent();
                                    return [3, 28];
                                case 26: return [4, this.$request('setSslVerify', { status: 0 })];
                                case 27:
                                    rdata = _c.sent();
                                    rdata.status && this.$refreshBrowser();
                                    _c.label = 28;
                    ...
                    $('.savePanelConfig').on('click', function (ev) { return __awaiter(_this, void 0, void 0, function () {
                        var name, _a, webname, session_timeout, domain, limitip, sites_path, backup_path, address, systemdate, url;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                    ...
                    $('.apiInterfaceBtn').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.setPanelApiView()];
                    ...
                    $('.editPanelAccount').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.setPanelUserView()];
                            case 1: return [2, _a.sent()];
                        }
                    }); }); });
                    $('.editPanelPassword').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.setPanelPawView()];
                            case 1: return [2, _a.sent()];
                        }
                    }); }); });
                    $('.panelSslConfig').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.setPanelSslConfigView()];
                            case 1: return [2, _a.sent()];
                        }
                    }); }); });
                    ...
                    $('.checkTwoStepConfig').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.googleAuthRelationView()];
                            case 1: return [2, _a.sent()];
                        }
                    }); }); });
                    $('.sslVerifyConfig').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.setAccessCertificateView()];
                            case 1: return [2, _a.sent()];
                        }
                    }); }); });
                    $('.setPanelPort').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.setPanelPortView()];
                            case 1: return [2, _a.sent()];
                        }
                    }); }); });
                    $('.setSafetyEntrance').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.setSafetyEntranceView()];
                            case 1: return [2, _a.sent()];
                        }
                    }); }); });
                    $('.setPawExpiration').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.setPawExpirationView()];
                            case 1: return [2, _a.sent()];
                        }
                    }); }); });
                    $('.bindBtUser').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.bindBtAccount()];
                            case 1: return [2, _a.sent()];
                        }
                    }); }); });
                    $('.unbindBtUser').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.unbindUser()];
                            case 1: return [2, _a.sent()];
                        }
                    }); }); });
                    $('.menuBarManage').on('click', function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.setPanelGroundView()];
                            case 1: return [2, _a.sent()];
                        }
                    }); }); });
                    ...
                    $('.setMessageChannelMail').on('click', function () { return _this.setMessageChannelView(_this.Info, 0); });
                    $('.setMessageChannelMailBtn').on('click', function () { return _this.setMessageChannelView(_this.Info, 0); });
                    $('.setMessageChannelNailNail').on('click', function () { return _this.setMessageChannelView(_this.Info, 1); });
                    $('.setAlarmMail,.setAlarmNailNail,.setAlarmMailBtn').on('click', function () { return _this.setAlarmView(_this.Info); });
