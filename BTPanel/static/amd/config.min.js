...
define(["require", "exports", "./snabbdom", "./public/public"], function (require, exports, snabbdom_1, public_1) {
  ...
  var Config = (function (_super) {
      ...
      Config.prototype.setPanelSslView = function () {
          return __awaiter(this, void 0, void 0, function () {
              var certSource, _a, certPem, privateKey, download_root;
              var _this = this;
              return __generator(this, function (_b) {
                  switch (_b.label) {
                      case 0: return [4, this.$request('getCertSource')];
                      case 1:
                          certSource = _b.sent();
                                      ...
                                      template: function () {
                                          ...
                                          return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                              ...
                                              (0, snabbdom_1.jsx)("div", { class: { pt10: true } },
                                                  this.$line({ title: '类型', width: lineWidth }, this.$select({ model: 'cert_type', width: inputWidth, options: [{ label: '自签证书', value: 1 }, { label: 'Let\'s Encrypt', value: 2 }, { label: '其他证书', value: 0 }] })),
                                                  this.$line({ title: '邮箱', width: lineWidth, hide: !(this.cert_type == 2) }, this.$input({ model: 'mail', width: inputWidth })),
                                  ...
                                  content: {
                                      ...
                                      methods: {
                                          savePanelSsl: function () {
                                              return __awaiter(this, void 0, void 0, function () {
                                                  var _a, certPem, privateKey, data;
                                                  return __generator(this, function (_b) {
                                                      switch (_b.label) {
