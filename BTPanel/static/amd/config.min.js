...
define(["require", "exports", "./snabbdom", "./public/public"], function (require, exports, snabbdom_1, public_1) {
    ...
    var Config = (function (_super) {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [4, this.$open({
                                    ...
                                    skin: 'panel-ssl',
                                    content: {
                                        data: { cert_type: certSource.cert_type || 1, email: '', certPem: certPem, privateKey: privateKey, agreement: false },
                                        template: function () {
                                            ...
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                                ...
                                                (0, snabbdom_1.jsx)("div", { class: { pt10: true } },
                                                    this.$line({ title: '类型', width: lineWidth }, this.$select({ model: 'cert_type', width: inputWidth, options: [{ label: '自签证书', value: 1 }, { label: 'Let\'s Encrypt', value: 2 }] })),
                                                    this.$line({ title: '邮箱', width: lineWidth, hide: parseInt(this.cert_type) !== 2 }, this.$input({ model: 'mail', width: inputWidth })),
                                                    this.$line({ title: '密钥(KEY)', width: lineWidth, hide: parseInt(this.cert_type) !== 1 }, this.$textarea({ model: 'privateKey', width: inputWidth, height: '80px', style: 'line-height: 16px;padding: 5px 8px;' })),
                                                    this.$line({ title: '证书(PEM)', width: lineWidth, hide: parseInt(this.cert_type) !== 1 }, this.$textarea({ model: 'certPem', width: inputWidth, height: '80px', style: 'line-height: 16px;padding: 5px 8px;' })),
        ...
        Config.prototype.setPanelSslConfigView = function () {
            return __awaiter(this, void 0, void 0, function () {
                var that, _a, certPem, privateKey, error_4;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            that = this;
                                        ...
                                        template: function () {
                                            return (0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
                                                (0, snabbdom_1.jsx)("div", { class: this.$class('myKeyCon ptb15') },
                                                    ...
                                                    (0, snabbdom_1.jsx)("div", { class: this.$class('ssl-btn pull-left mtb15'), style: { width: "100%" } }, this.$button({ title: '保存', click: this.savePanelSsl.bind(this) }))),
        ...
        Config.prototype.setAlarmView = function (configInfo) {
            return __awaiter(this, void 0, void 0, function () {
                var rdata, _a, mail, dingding, error_13;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4, this.$request('getLoginAlarm')];
                        case 1:
                            rdata = _b.sent();
                                    ...
                                    success: function () { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            ...
                                            $('#mail_alarm,#dingding_alarm').on('click', function (ev) { return __awaiter(_this, void 0, void 0, function () {
                                                var that, checked, type, _a, error_14;
                                                return __generator(this, function (_b) {
                                                    switch (_b.label) {
                                                        case 0:
                                                        ...
                                                        case 2:
                                                            _a = _b.sent();
                                                            return [3, 5];
                                                        case 3: return [4, this.$request('clearLoginAlarm', { type: type })];
                                                        case 4:
                                                            _a = _b.sent();
                                                            _b.label = 5;
                                                        case 5:
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 8:
                            ...
                            mailMessage = $('.setMessageChannelMail'), nailNailMessage = $('.setMessageChannelNailNail'), setAlarmMail = $('.setAlarmMail'), setAlarmNailNail = $('.setAlarmNailNail'), menuHideList = $('[name="menu_hide_list"]'), statusCode = $('[name="status_code"]');
                            user_mail = messageChannelInfo.user_mail, dingding = messageChannelInfo.dingding, alarm_mail = loginAlarmInfo.msg.mail, alarm_dingding = loginAlarmInfo.msg.dingding;
                            if (user_mail.user_name)
                                mailMessage.text('邮箱已设置').removeClass('bt_warning').addClass('btlink');
                            if (dingding.dingding)
                                nailNailMessage.text('钉钉/企业微信已设置').removeClass('bt_warning').addClass('btlink');
                            if (alarm_mail)
                                setAlarmMail.text('邮箱已设置').removeClass('bt_warning').addClass('btlink').next().hide();
                            if (alarm_dingding)
                                setAlarmNailNail.text('钉钉/企业微信已设置').removeClass('bt_warning').addClass('btlink').prev().hide();
                            menuList = [];
        ...
        Config.prototype.eventBind = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    $('.setMessageChannelMail').on('click', function () { return _this.setMessageChannelView(0); });
                    $('.setMessageChannelMailBtn').on('click', function () { return _this.setMessageChannelView(0); });
                    $('.setMessageChannelNailNail').on('click', function () { return _this.setMessageChannelView(1); });
                    $('.setAlarmMail,.setAlarmMailBtn').on('click', function () { return _this.setAlarmView(_this.Info.message_channel_info); });
