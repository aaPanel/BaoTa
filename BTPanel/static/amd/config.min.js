                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [4, this.$open({
                                    ...
                                    yes: function (config) { return __awaiter(_this, void 0, void 0, function () {
                                        var close, vm, cert_type, email, privateKey, certPem, agreement, param, rdata;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    close = config.close, vm = config.vm;
                                                ...
                                                case 2:
                                                    ...
                                                    close() && this.$refreshBrowser(location.href.replace(/^http:/, 'https:'), 3000);
                                                    return [2];
                                            }
                                        });
                                    }); }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            nodeConfig = _a.sent();
                            select_1 = nodeConfig.map(function (item) { return ({ label: item.node_name, value: item.node_id }); });
                            return [4, this.$open({
                                    title: '设置面板云端通讯节点配置',
                                    area: ['420px', '180px'],
                                    btn: ['提交', '取消'],
                                    ...
                                    yes: function (config) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    close = config.close, vm = config.vm;
                                                    return [4, this.$request('setNodeConfig', { node_id: vm.nodeId })];
                                                case 1:
                                                    res = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 2:
                            _a = _c.sent(), configInfo = _a[0], twoStep = _a[1], sslVerify = _a[2], pawComplexity = _a[3], bindUserInfo = _a[4], messageChannelInfo = _a[5], loginAlarmInfo = _a[6], getMenuList = _a[7], getNodeConfig = _a[8];
                            loadT.close();
