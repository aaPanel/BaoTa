                ...
                bt.open({
                  ...
                  success: function (layers) {
                    if (rhtml.indexOf("CodeMirror") != -1) {
                      ...
                      loadScript([
                        "/static/codemirror/lib/codemirror.js?v=1758787359",
                        "/static/codemirror/addon/edit/editAll.js?v=1758787359",
                        "/static/codemirror/mode/modeAll.js?v=1758787359",
                        "/static/codemirror/addon/dialog/dialog.js?v=1758787359",
                        "/static/codemirror/addon/search/search.js?v=1758787359",
                        "/static/codemirror/addon/scroll/annotatescrollbar.js?v=1758787359",
                      ]);
                    }
        ...
        success: function () {
          bt_tools.send(
            ...
            function (res) {
              jQuery
                .ajax({
                  url: '/static/js/jquery.qrcode.min.js?v=1758787359',
                  dataType: 'script',
                  cache: true,
                })
                .done(function () {
